...
up_hack:
	docker-compose -f dev.yml -f ras-services.yml -f rm-services.yml up -d && docker-compose -f dev.yml -f ras-services.yml -f rm-services.yml up -d && docker stop oauth2-service && docker start oauth2-service
